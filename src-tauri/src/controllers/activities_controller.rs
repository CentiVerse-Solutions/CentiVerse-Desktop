use chrono::Utc;
use crate::models::activities::{ActivityRes, CreateActivityReq,UpdateActivityReq};
...
pub async fn update_activity_handler(
    ...
    if activity.paid_by_id != user_id {
        return Err(AppError::Unauthorized("You are not authorized to update this activity".to_string()));
    }
